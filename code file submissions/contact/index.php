...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $address = "manjusha.bolishetty@gmail.com";
        $mail->AddAddress($address, "Shop Online");
        $mail->Subject    = "Shop Online Contact Form Submission | " . $name;
    ...
    <div class="section page">
        ...
        <div class="wrapper">
            ...
            <?php if (isset($_GET["status"]) AND $_GET["status"] == "thanks") { ?>
                <p>Thanks for the email! We&rsquo;ll be in touch as soon as possible!</p>
            <?php } else { ?>

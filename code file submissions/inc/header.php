...
<body>
	...
	<div class="header">
		...
		<div class="wrapper">
			...
			<h1> <class="branding-title"><a href="<?php echo BASE_URL; ?>">Shop Online</a></h1>
			...
			<ul class="nav">
				...
				<li class="cart <?php if ($section == "cart") { echo "on"; } ?>"><a href="<?php echo BASE_URL; ?>delete/">Shopping Cart</a></li></a></li>
